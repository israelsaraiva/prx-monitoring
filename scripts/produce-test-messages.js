...
async function produceTestMessages() {
  ...
  const flowIds = [
    'b29047e9-fa72-4375-834d-a39d6274ff31',
    'c39058f0-gb83-5486-945e-b40f7385dg42',
    'd40169g1-hc94-6597-a56f-c51g8496eh53',
  ];
  ...
  console.log(
    `Note: Make sure the consumer is connected before producing messages, or use 'fromBeginning: true' to read old messages`
  );
  ...
  flowIds.forEach((flowId, flowIndex) => {
    ...
    for (let i = 0; i < messageCount; i++) {
      ...
      const errorMessage =
        !success && command === 'backendError'
          ? `the fsm with flowId ${flowId} is in final state and can not handle messages`
          : undefined;
